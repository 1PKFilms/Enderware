 ...
 * IMPORTANT THIS FILE IS MODIFIED BY ENDERWARE (COUNTS FROM VERSION 0.0.2)
 * IT IS JUST TO REGISTER THE MODCONFIG
 */
...
public class Configuration
{
    ...
    public Configuration(File file)
    {
        ...
        settings = new ModSetting(this,file);
    }
    ...
    public Property get(String category, String key, String defaultValue, String comment, Property.Type type)
    {
        ...
        if (cat.containsKey(key))
        {
            ...
            this.settings.addEntry(category, key, prop.value);
            return prop;
        }
